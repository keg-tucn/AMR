...
from filters import NoMissingAllignmentInfoFilter, TreeFilter, TokenToNodeAlignmentFilter, ProjectiveTreeFilter, PerfectALignmentFilter
...
def generate_statistics(file_path):
    ...
    print("Filter: none, Total number of instances: {0}, Number of filtered instances: {1}".format(instances,filtered_instances))
    ...
    print("Filter: NoMissingAllignmentFilter, Total number of instances: {0}, Number of filtered instances: {1}".format(instances,filtered_instances))

    #tree
    tree_filters = [TreeFilter()]
    instances,filtered_instances = generate_dataset_statistics(file_path,tree_filters)
    print("Filter: TreeFilter, Total number of instances: {0}, Number of filtered instances: {1}".format(instances,filtered_instances))
    ...
    print("Filter: AlignedTreeFilter, Total number of instances: {0}, Number of filtered instances: {1}".format(instances,filtered_instances))
    ...
    print("Filter: Token1WordsFilter, Total number of instances: {0}, Number of filtered instances: {1}".format(instances,filtered_instances))
    ...
    print("Filter: Token2WordsFilter, Total number of instances: {0}, Number of filtered instances: {1}".format(instances,filtered_instances))
    ...
    print("Filter: Token3WordsFilter, Total number of instances: {0}, Number of filtered instances: {1}".format(instances,filtered_instances))
    ...
    print("Filter: ProjectiveAlignedTreee, Total number of instances: {0}, Number of filtered instances: {1}".format(instances,filtered_instances))
