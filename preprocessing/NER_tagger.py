...
class StanfordNERTagger(StanfordTagger):
    ...
    Example:
        ...
        >>> st = StanfordNERTagger('/home/andreea/stanford-ner-2017-06-09/classifiers/english.all.3class.distsim.crf.ser.gz', '/home/andreea/stanford-ner-2017-06-09/stanford-ner.jar') # doctest: +SKIP
